			...
			<div class="container">
				<div class="row">
					<div class="col-sm-12 py-4">
						...
						<p class="text-muted">Explore our offerings, book your
							cleaning service, and provide feedback to help us serve you
							better.</p>
						<div class="dropdown">
							...
							<ul class="dropdown-menu" aria-labelledby="servicesDropdown">
								<li><a class="dropdown-item" href="#">Available
										Services</a></li>
								<li><a class="dropdown-item" href="booking.html">Book Appointments</a>
								</li>
