...
Integer userId = (Integer) session.getAttribute("userId"); // Retrieve auto-incremented user ID
String userName = "";
String userRole = "";
...
try {
	...
	// Fetch user details for the popup (use auto-incremented user ID)
	if (userId != null) {
...
<body>
	...
	<script>
		...
		window.onload = function() {
			const userRoleId =
	<%=userRoleId != null ? userRoleId : "null"%>
		;
			if (userRoleId !== null) {
